/* ============================================================
   ...
   It keeps your AI API key SERVER-SIDE (in Vercel env vars);
   students never see it. Access is gated by a class passcode.
...
export default async function handler(req, res) {
  ...
  // Parse body (Vercel usually parses JSON automatically; handle string too).
  let body = req.body;
  ...
  if (!body.passcode || body.passcode !== process.env.CLASS_PASSCODE) {
